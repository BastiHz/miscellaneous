...
chaos_polygon <- function(n = 3, move_distance = 0.5,
    ...
    targets <- sample(1:n, num_iterations, replace = TRUE)
...
# chaos_polygon(n = 5, move_distance = 0.62, num_iterations = 3000)
# chaos_polygon(n = 6, move_distance = 2/3)
# chaos_polygon(n = 4, type = "l")
# chaos_polygon(30, move_distance = 0.91, num_iterations = 2000)
